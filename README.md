...
- **To download annotated datasets** upon agreeing on the following conditions: This dataset is intended for academic purposes only. To present label leakage, please do not upload/redistribute this data without the author's consent. The use of this dataset requires agreement to the conditions listed in the [form](https://forms.gle/UeVjEPrrnJx7D4Yv5). The dataset will be available for downloading after filling out the form. 
